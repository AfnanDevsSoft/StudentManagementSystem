...
export const StudentProfileError: React.FC = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[50vh] space-y-6">
            <div className="text-center py-12 max-w-md mx-auto">
                ...
                <h2 className="text-2xl font-bold mb-2">Student Profile Connection Issue</h2>
                <p className="text-muted-foreground mb-8">
                    Your user account is not correctly linked to a student profile.
